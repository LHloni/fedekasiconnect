<?php
   require "Main.php";
    ...
    $arrOfInfo = $mainClass->servicesPage();
    $mainClass->post->postServices($mainClass->user->userID);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  <?php
    ...
    <section class="row center-xm center-sm center-md center-lg">
		...
		<?php
                $mainClass->post_div('Any Services you would like to offer?','service');    
            ?>
	   </div>
        ...
        echo ' </div>';     
           ...
           id="notification_div">
             ...
             <?php
                  $mainClass->filterTabForNewsFeed('service'); 
                  $mainClass->filterTabForPoroduct('service');   
                  $mainClass->filterTabForService('service');
                  ?>
